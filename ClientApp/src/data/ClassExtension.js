class ModelSummaryExtension extends Autodesk.Viewing.Extension {
    ...
    load() {
        console.log('ModelSummaryExtension has been loaded - Eric');
        return true;
    }
    ...
    // Testing customize function
    customize() {
        console.log('execute customize function here');
        listItems = [];
        ...
        this.getAllLeafComponents((dbIds) => {
            ...
            this.viewer.model.getBulkProperties(dbIds, filteredProps, (items) => {
                ...
                items.forEach((item) => {
                    console.log("customize-function", item)
    ...
    onToolbarCreated() {
        console.log('Creating a new toolbar group if it doesn\' exist');
        ...
        // Instead of executing getAllLeafComponents with onClick function. We can call the function here

        // Add a new button to the toolbar group
        this._button = new Autodesk.Viewing.UI.Button('ModelSummaryExtension has been unloaded');
...
Autodesk.Viewing.theExtensionManager.registerExtension('ModelSummaryExtensionClass', ModelSummaryExtension);

//function getAllLeafComponents_v2(viewer, callback) {
